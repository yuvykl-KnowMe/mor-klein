...
export const metadata: Metadata = {
  ...
  title: {
    absolute: "מור קליין | פסיכותרפיסטית ועובדת סוציאלית קלינית M.S.W",
  },
  description:
    "פסיכותרפיסטית אדלריאנית ועובדת סוציאלית קלינית. טיפול אישי בזום או פנים אל פנים בהרצליה. התמחות בקריירה, זוגיות והורות צעירה.",
...
const jsonLd = {
  ...
  "@type": "Person",
  name: SITE_NAME,
  jobTitle: "פסיכותרפיסטית ועובדת סוציאלית קלינית",
  url: SITE_URL,
  telephone: PHONE_TEL,
};
      ...
      <section aria-labelledby="about-heading">
        <div className="mx-auto max-w-3xl px-6 py-20 sm:py-28 lg:py-32">
          <Reveal>
            ...
            >
              מור קליין, פסיכותרפיסטית ועובדת סוציאלית קלינית
            </h1>
            <div className="mt-6 flex flex-col gap-4 text-lg text-ink-muted">
              <p>
                שלום, אני מור. אני פסיכותרפיסטית אדלריאנית ועובדת סוציאלית קלינית
                (M.S.W), ואני מלווה אנשים בגילאי העשרים עד הארבעים בצמתים
          ...
          <Reveal className="mt-14 sm:mt-16">
            ...
            <div className="mt-6 flex flex-col gap-4 text-lg text-ink-muted">
              <p>
                את ההכשרה כפסיכותרפיסטית אדלריאנית אני עוברת במכון אדלר, מאז שנת
                2024, והיא מצטרפת לתואר שני בעבודה סוציאלית קלינית (M.S.W)
                מאוניברסיטת בר-אילן. את דרכי האקדמית התחלתי בתואר ראשון (B.Sc)
                במדעי ההתנהגות במכללה למינהל.
              </p>
              <p>
