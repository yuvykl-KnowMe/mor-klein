      ...
      <article className="mx-auto max-w-3xl px-6 py-20 sm:py-28 lg:py-32">
        ...
        <section className="mt-12">
          ...
          <div className={proseBody}>
            ...
            <p>
              אבל הטיפול אינו נשאר רק ברמת ההבנה. המטרה היא לחבר בין מה שמבינים
              לבין איך חיים, לעזור לאדם לזהות את הכוחות שלו ולמצוא דרך להתקדם.
            </p>
          </div>
        </section>
        ...
        <section className="mt-12">
          ...
          <div className={proseBody}>
            <p>
              ...
              לנו. גם כשאנחנו נושאים איתנו דפוסים ישנים ופצעים, עדיין אפשר לבחור
              איך להתייחס אליהם.
            </p>
            <p>
              על{" "}
            ...
            <p>
              זו אחת הסיבות שאני כל כך מתחברת לגישה האדלריאנית. היא לא מסתפקת
              בלהסביר למה אנחנו כאלה. היא שואלת גם לאן אנחנו רוצים ללכת מכאן.
            </p>
          </div>
        </section>
      </article>
