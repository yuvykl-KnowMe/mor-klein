      ...
      <article className="mx-auto max-w-3xl px-6 py-20 sm:py-28 lg:py-32">
        ...
        <div className={proseBody}>
          ...
          <p>
            ...
            של טיפול אינה לחפש אשמים. המטרה היא להבין איך הפכנו להיות מי שאנחנו,
            ואיך החוויות שעברנו ממשיכות להשפיע על הבחירות שאנחנו עושים גם היום.
          </p>
        </div>
        ...
        <section className="mt-12">
          ...
          <div className={proseBody}>
            ...
            <p>
              אולי לא בחרנו את כל מה שקרה לנו. לא בחרנו את המשפחה שבה נולדנו ולא
              את החוויות שעיצבו אותנו. אבל כבוגרים, אנחנו יכולים לבחור איך להתייחס
              אל החוויות האלה ואיזה חיים לבנות מכאן.
            </p>
          </div>
        </section>
