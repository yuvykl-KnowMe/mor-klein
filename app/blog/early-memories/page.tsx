        ...
        <section className="mt-12">
          ...
          <div className={proseBody}>
            <p>
              ...
              המטרה היא להשתמש בהבנות הללו כדי לחיות את ההווה בצורה מודעת יותר
              ולבחור את הכיוון שאליו נרצה לצעוד.
            </p>
            <p>
              בסופו של דבר, זיכרון מוקדם אינו רק סיפור מהילדות – הוא הזמנה להכיר
              את עצמנו לעומק, ומתוך ההיכרות הזו לאפשר שינוי, צמיחה ובחירה.
            </p>
          </div>
        </section>
      </article>
