        ...
        <section className="mt-12">
          ...
          <div className={proseBody}>
            <p>
              ...
              שאנחנו. הוא מתחיל כשמבינים את הסיפור שלנו לעומק ומגלים שיש יותר
              אפשרויות ממה שחשבנו.
            </p>
            <p>
              לפעמים עצם ההבנה הזאת היא הצעד הראשון. לא להפוך לאדם אחר. פשוט לא
              להגיב באופן אוטומטי לאותם דפוסים ישנים.
            </p>
          </div>
        </section>
      </article>
