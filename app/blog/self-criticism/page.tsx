      ...
      <article className="mx-auto max-w-3xl px-6 py-20 sm:py-28 lg:py-32">
        ...
        <section className="mt-12">
          ...
          <div className={proseBody}>
            <p>
              ...
              אנשים רבים, היא התפתחה כניסיון להגן מפני טעויות, מפני דחייה ומפני
              ביקורת של אחרים.
            </p>
            <p>
        ...
        <section className="mt-12">
          ...
          <div className={proseBody}>
            ...
            <p>
              ומתוך ההבנה הזאת אפשר להתחיל לפתח קול פנימי שונה. קול שמכיר במאמץ
              ולא רק בתוצאה, ושמאפשר לטעות מבלי להתפרק. לא כדי לוותר על שאיפות,
              אלא כדי לצמוח מתוך כבוד עצמי ולא מתוך מאבק.
            </p>
          </div>
        </section>
        ...
        <section className="mt-12">
          ...
          <div className={proseBody}>
            <p>
              בסופו של דבר, כולנו טועים, מתבלבלים ונכשלים. זה לא סימן לחולשה.
              זו חלק מהחוויה האנושית.
            </p>
            <p>
              בעיניי, אחד הדברים המשמעותיים ביותר שאדם יכול לפתח הוא היכולת להיות
              לצד עצמו גם ברגעים שהדברים אינם מושלמים. לא כדי לוותר על שאיפות, אלא
              כי התפתחות אמיתית לא נבנית על שיפוט מתמיד. היא נבנית על היכולת לראות
              את עצמנו כפי שאנחנו, עם הכוחות והמגבלות גם יחד.
            </p>
          </div>
        </section>
      </article>
