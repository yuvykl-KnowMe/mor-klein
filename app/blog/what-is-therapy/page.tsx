        ...
        <section className="mt-12">
          ...
          <div className={proseBody}>
            ...
            <p>
              ...
              אלא אילו דפוסים חוזרים על עצמם ואיך הם משפיעים על הבחירות שלכם.
              המטרה אינה לפרוק או לקבל עצה, אלא לפתח הבנה עמוקה יותר של עצמכם.
            </p>
          </div>
        </section>
        ...
        <section className="mt-12">
          ...
          <div className={proseBody}>
            <p>
              ...
              שלא מתאפשר בדרך כלל בתוך שגרת החיים. יש מרחב להבין את הסיפור שלנו
              ולזהות את הדפוסים שמלווים אותנו. מתוך זה, דברים שלא היו ברורים קודם
              מתחילים להיראות אחרת.
            </p>
            <p>
              אבל מעבר להבנה, טיפול יוצר הזדמנות לתנועה. לבחור כיצד להמשיך מכאן.
              כי לפעמים שינוי
