...
const faqs = [
  ...
  },
  {
    ...
    a: "פסיכולוג הוא תואר מוגן בחוק הישראלי — מחייב לימוד אקדמי ספציפי ורישוי ממשרד הבריאות. פסיכותרפיסט הוא כינוי לאנשי מקצוע שעברו הכשרה טיפולית מעמיקה, ביניהם עובדים סוציאליים קליניים. מור היא עובדת סוציאלית קלינית (M.A.) ופסיכותרפיסטית אדלריאנית מוסמכת, בוגרת התוכנית התלת-שנתית של מכון אדלר — שתי הכשרות נפרדות ומשלימות.",
  },
  {
