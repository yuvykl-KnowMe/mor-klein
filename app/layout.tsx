...
export const metadata: Metadata = {
  ...
  description:
    "מור קליין, פסיכותרפיסטית ועובדת סוציאלית קלינית (M.A.), מלווה בזום בגישה אדלריאנית, בצמתים של קריירה, זוגיות והורות צעירה. שיחת היכרות ראשונה ללא עלות.",
  ...
  openGraph: {
    ...
    description:
      "מור קליין, פסיכותרפיסטית ועובדת סוציאלית קלינית (M.A.), מלווה בזום בגישה אדלריאנית, בצמתים של קריירה, זוגיות והורות צעירה.",
  },
};
