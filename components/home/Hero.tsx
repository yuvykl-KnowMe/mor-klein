      ...
      <div className="mx-auto grid max-w-5xl items-center gap-12 px-6 py-20 sm:grid-cols-[1fr_auto] sm:gap-16 sm:py-28 lg:py-32">
        <div className="flex flex-col gap-7">
          ...
          <p className="max-w-xl text-lg text-ink-muted">
            אני מור קליין, פסיכותרפיסטית ועובדת סוציאלית קלינית (M.A.). אני
            מלווה אנשים בגילאי העשרים עד הארבעים בצמתים של קריירה, זוגיות והורות
            צעירה. רבים מהם חיים בקצב תובעני, אנשי הייטק, מנהלות ומנהלים,
            והעומס והלחץ מהעבודה לא תמיד נשארים במשרד, הם נכנסים גם הביתה. נעבוד
            יחד בשיחות בזום, בקצב שמתאים לחיים עמוסים.
          </p>
