    ...
    <footer className="border-t border-line">
      <div className="mx-auto flex max-w-5xl flex-col gap-2 px-6 py-10 text-sm text-ink-muted">
        ...
        <p>
          <a
            href={`mailto:${EMAIL}`}
            className="inline-flex min-h-11 items-center text-accent-deep underline underline-offset-4 transition-colors duration-300 ease-out hover:text-accent-deeper"
            dir="ltr"
          >
            {EMAIL}
          </a>
